...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, color, blend_depth, near_depth, alpha, radii, geomBuffer, binningBuffer, imgBuffer = _C.rasterize_gaussians(*args)
        ...
        return color, radii, blend_depth, near_depth, alpha

    @staticmethod
    def backward(ctx, grad_color, grad_radii, grad_blend_depth, grad_near_depth, grad_alpha):
